    ...
    <>
      <section id="who-was-sant-kabir">
        ...
        <p>
          ...
          (1440–1518) was a well-known Indian poet and spiritual teacher linked to the Bhakti and Sufi traditions. He is
          respected by Hindus, Muslims, and Sikhs. Some of his verses are also included in the{' '}
          <a
        ...
        <p>
          ...
          tradition. Through Kabir Dohe API, we aim to make his timeless teachings easy to access in the modern digital
          world.
        </p>
      </section>

      <section id="unlock-the-wisdom-of-kabir">
        <h2>Explore the Wisdom of Kabir with Our Dohe API</h2>
        ...
        <p>
          ...
          that gives access to over <a href="/api/couplets">2500+ dohe (couplets)</a> of Sant Kabir, a well-known Indian
          poet and saint. Each doha includes the original Hindi text, meaning, and English translation.
        </p>
      ...
      <section id="why-use-kabir-dohe-api">
        <h2>Why use Kabir Dohe API?</h2>
      ...
      <section id="when-to-use-kabir-dohe-api">
        <h2>When to Use Kabir Dohe API?</h2>
        ...
        <ul>
          ...
          <li>
            <strong>Daily Quote Apps:</strong> Show dohe as daily quotes to inspire users and encourage self-reflection.
          </li>
      ...
      <section id="who-can-use-kabir-dohe-api">
        <h2>Who Can Use Kabir Dohe API?</h2>
      ...
      <section id="what-can-you-build">
        <h2>What Can You Build with Kabir Dohe API?</h2>
        ...
        <ul>
          ...
          <li>
            <strong>Educational Websites:</strong> Develop platforms to teach Indian philosophy, values, and literature.
          </li>
