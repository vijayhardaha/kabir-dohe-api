...
export function Introduction(): React.JSX.Element {
  return (
    <section>
      <h1 className="mb-4 text-3xl font-bold text-gray-800">Introduction to Kabir Ke Dohe API</h1>
      <p className="mb-4 text-lg text-gray-700">
        The <strong>Kabir Ke Dohe API</strong> is a free and open RESTful API that provides programmatic access to a
        vast collection of over <strong>2500 dohas (couplets)</strong> written by <strong>Sant Kabir</strong>, a revered
        Indian mystic poet and spiritual reformer. His verses, rich in meaning and simplicity, offer timeless insights
        into life, morality, love, and human nature.
      </p>
      <p className="mb-4 text-lg text-gray-700">
