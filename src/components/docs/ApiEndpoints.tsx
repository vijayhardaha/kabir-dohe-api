  ...
  return (
    <section>
      ...
      <div className="rounded-lg border border-green-600 bg-green-50 p-5">
        ...
        <p className="mb-2 text-gray-700">
          You can use optional <strong>query parameters</strong> to filter the results, paginate the output, or search
          by keyword. This makes it ideal for applications that need dynamic spiritual content, quote-of-the-day
          features, educational tools, or Indian philosophy resources.
        </p>
