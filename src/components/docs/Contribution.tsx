	...
	return (
		<section>
			<div className="rounded-lg border border-slate-300 p-6">
				...
				<p className="mb-4">
					<strong>We need your help!</strong> This project grows through community
					contributions.
				</p>

				<p className="mb-4">
					Whether you’re a developer or non-developer, there are many ways to help improve
					this project:
				</p>

				<ul className="mb-4 list-inside list-disc space-y-2 pl-4">
					<li>
						<strong>Developers</strong>: Fix bugs, improve code, add new features, or
						enhance API endpoints.
					</li>
					<li>
						<strong>Non-developers</strong>: Help with translations, data verification,
						and documentation.
					</li>
					<li>
						<strong>Everyone</strong>: We maintain our data in Excel sheets where you
						can help fix typos, improve translations, and contribute new dohe.
					</li>
				</ul>
